...
function Router() {
    return (_jsxs(Switch, { children: [_jsx(Route, { path: "/", component: Dashboard }), _jsx(Route, { path: "/make-bill", component: MakeBill }), _jsx(Route, { path: "/view-bills", component: ViewBills }), _jsx(Route, { path: "/items", component: ItemManagement }), _jsx(Route, { path: "/settings", component: Settings }), _jsx(Route, { path: "/404", component: NotFound }), _jsx(Route, { component: NotFound })] }));
}
function App() {
